---
name: commit
description: Analyze git changes, stage as needed, generate a Conventional Commit message, and create a commit. Use when the user asks to commit changes or runs /commit.
---
